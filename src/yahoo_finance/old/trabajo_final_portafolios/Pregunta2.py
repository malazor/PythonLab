...
tickers = ["SPY", "IDEV", "EMXC", "MCHI", "GOVT", "GLD"]
...
pesos = {"SPY":0.1667, "IDEV":0.1667, "EMXC":0.1667, "MCHI":0.1667, "GOVT":0.1667, "GLD":0.1667}
...
pesos_array = np.array([0.1667,0.1667,0.1667,0.1667,0.1667,0.1667])
